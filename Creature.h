...
// Study animation overlay (2 frames). Kept as a 2x2 tile matrix (4 tiles of 8x8 each).
const PROGMEM uint8_t studyMatSprites[][4][10] = {
  {
    // Frame 0: closed book
    { 8, 8,
      0b00000000,
...
// Shower animation overlay (2 frames). Kept as a 2x2 tile matrix (4 tiles of 8x8 each).
const PROGMEM uint8_t showerMatSprites[][4][10] = {
  {
    // Frame 0: shower head + droplets
    { 8, 8,
      0b00011000,
      0b00111100,
      0b01111110,
  ...
  {
    // Frame 1: shower head + shifted droplets
    { 8, 8,
      0b00011000,
      0b00111100,
      0b01111110,
